export function renderProduct(targetElement, product) {
  const { name, images, description, prices, on_sale, is_in_stock } = product;
  ...
  continueShoppingLink.classList.add("continue-shopping");
  ...
  productContainer.appendChild(stockAvailability);
